...
You can also publish a note to the internet and share the URL with others.
     ...
     <div className=' mx-48 '><div className=' pt-20 text-white font-sans  text-5xl  font-bold py-4'><b>Your work, everywhere you are</b></div>
     <br/><div className='px-4 font-sans  text-white text-[8]  '>Access your notes from your computer, phone or tablet by synchronising with various services, including<br/> whitespace, Dropbox and OneDrive. The app is available on Windows, macOS, Linux, Android and iOS. A <br/>terminal app is also available!</div><br/><br/><div className='px-[300]'><button className='bg-[#4F9CF9] px-4 py-4 mx-96 font-sans rounded-md text-xs  '>Try TasKey &#x2192;</button></div></div>
